...
export const PLANS: Plan[] = [
  { id: "HYRO-01001", duration: "1 HORA",  hours: "60 MINUTOS", title: "Extensão Créditos Lovable Infinitos por 1 Hora (Teste)",   description: "Ideal para testar a extensão Unlimited do Lovable.dev por 60 minutos, com ativação imediata via PIX.",           price: 5,   old: 14.9,   stock: 15, sold: 1284, image: loveHyro1h.url },
