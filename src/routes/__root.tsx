...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Love Hyro · Extensão premium para congelar créditos" },
      ...
      { property: "og:description", content: "Love Hyro é a extensão essencial para congelar seus créditos no navegador com PIX e liberação imediata." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Love Hyro · Extensão premium para congelar créditos" },
      { name: "twitter:description", content: "Love Hyro é a extensão essencial para congelar seus créditos no navegador com PIX e liberação imediata." },
